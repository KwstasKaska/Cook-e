...
export default function NutrReviewsList({
  reviews,
  loading,
  fetchingMore,
  hasMore,
        ...
        <div className="flex flex-col gap-4">
          ...
          {hasMore && (
            <button
              ...
              className="mt-2 w-full rounded-xl border-2 border-cookie-400 py-1.5 text-cookie-400 transition hover:bg-cookie-400 hover:text-white disabled:opacity-50"
            >
