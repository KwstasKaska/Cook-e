  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-3xl lg:max-w-4xl px-6 pb-16 pt-10">
        ...
        <p className="mb-8 text-center">{t('cart.subtitle')}</p>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl bg-surface px-4 pb-6 pt-4 shadow-lg">
                  ...
                  >
                    <button
                      ...
                      style={{
                        ...
                        backgroundColor: isChecked ? '#C9955A' : 'transparent',
                      }}
                    >
                      {isChecked && (
                        <svg
            ...
            <div className="mt-4 flex items-center justify-between border-t-2 border-cookie-200 pt-4">
              <p>
              ...
              <button
                ...
                className={`rounded-full border-2 px-5 py-1.5 transition ${
                  checkedCount > 0
                    ? 'cursor-pointer border-myRed text-myRed hover:bg-myRed hover:text-white'
                    : 'cursor-not-allowed border-cookie-200'
                }`}
              >
