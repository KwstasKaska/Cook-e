    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white p-8 shadow-2xl mx-4">
        ...
        <p className="mb-6 text-center text-sm text-gray-400">
          {FAKE_PROFILE.ratingTotal} {t('chef.rating.reviews')}
        </p>
...
export default function ChefProfile() {
  ...
  const stats = [
    { label: t('chef.profile.recipes'), value: FAKE_PROFILE.recipesCount },
    { label: t('chef.profile.followers'), value: FAKE_PROFILE.followersCount },
    { label: t('chef.profile.articles'), value: FAKE_PROFILE.articlesCount },
  ];
          ...
          <div className="flex flex-col items-center gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <p className="mt-1 text-xs text-gray-500">
                {FAKE_PROFILE.ratingTotal} {t('chef.profile.user_reviews')}
              </p>
            </div>
          </div>
